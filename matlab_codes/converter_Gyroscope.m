...
fid =fopen('/Users/jenny/Desktop/me_pghd/GDFbyMatlab/Gyroscope.csv');
buffer=fgetl(fid);
m = textscan(fid,'%s%f%f%f%f','delimiter',',');
m = m(2:5);
x = [m{:}];

filename = '/Users/jenny/Desktop/me_pghd/GDFbyMatlab/Gyroscope_03';
...
start_time = [2021 02 19 15 40 0.00];
