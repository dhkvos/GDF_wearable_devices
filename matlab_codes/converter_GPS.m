...
fid =fopen('/Users/jenny/Desktop/me_gdf/GDFbyMatlab/GPS.csv');
buffer=fgetl(fid);
m = textscan(fid,'%s%f%f%f%f','delimiter',',');
m = m(2:5);
x = [m{:}];

filename = '/Users/jenny/Desktop/new/GPS_03';
column_label = {'Milliseconds';'Latitude';'Longitude';'Altitude'}; % channel identification, max 80 char. per channel
